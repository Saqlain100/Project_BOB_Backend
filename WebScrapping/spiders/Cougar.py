...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://www.cougar.com.pk/search?q=sale*&page=" + str(i) for i in range(1, 500)]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for article_url in article_urls:
            yield scrapy.Request('https://www.cougar.com.pk'+article_url, callback=self.parse_dir_contents)
    ...
    def parse_dir_contents(self, response):
        ...
        if old_price == None:
            old_price = 0
        final_price = response.xpath("//span[@class='product__price sale-price']/text()").extract_first()
