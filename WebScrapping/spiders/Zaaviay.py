...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://zaaviay.pk/collections/sale?page="+str(i) for i in range(1,200)]
    ...
    def parse(self, response):
        article_urls = response.xpath("//div[@class='product-image']/a/@href").extract()
        for article_url in article_urls:
            article_url = "https://zaaviay.pk" + article_url
    ...
    def parse_dir_contents(self, response):
        ...
        description = response.xpath("//div[@class='short-description']/p[@class='p1']/text()").extract_first()
        ...
        image_links = response.xpath(
            "//img[@class='product-featured-image']/@src").extract()
