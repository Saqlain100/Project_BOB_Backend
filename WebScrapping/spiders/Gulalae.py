...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls=[]
        urls.append("https://www.gulalae.com/collections/sale")
    ...
    def parse(self, response):
        ...
        for article_url in article_urls:
            article_url = "https://www.gulalae.com/" + article_url
    ...
    def parse_dir_contents(self, response):
        ...
        description = response.xpath("//div[@class='product-single__description rte']/p/text()").extract_first()
