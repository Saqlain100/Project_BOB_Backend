...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://www.acegalleria.com/collections/sale?page=" + str(i) for i in range(1, 500)]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for article_url in article_urls:
            yield scrapy.Request('https://www.acegalleria.com'+article_url, callback=self.parse_dir_contents)
    ...
    def parse_dir_contents(self, response):
        ...
        if old_price == None:
            old_price = 0
        final_price = response.xpath("//span[contains(@class,'price-item--sale')]/text()").extract_first()
