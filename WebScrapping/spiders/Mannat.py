...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        urls = ["https://mannatclothing.com/collections/sale?page="+str(i) for i in range(1,200)]
    ...
    def parse(self, response):
        ...
        for article_url in article_urls:
            article_url = "https://mannatclothing.com" + article_url
    ...
    def parse_dir_contents(self, response):
        ...
        if old_price == None:
            old_price = 0
        final_price = response.xpath("//span[@class='product__price on-sale']/span/text()").extract_first()
